    ...
    <div className="min-h-screen bg-[#060606] text-gray-100 flex items-center justify-center px-4">
      <div className="w-full max-w-3xl bg-[#0b0b0b] border border-[#111] rounded-2xl p-8 shadow-[0_20px_80px_rgba(0,0,0,0.45)]">
        <div className="flex items-center justify-between mb-6">
          <div>
            <p className="text-sm uppercase tracking-wide text-emerald-400">Teacher</p>
            <h1 className="text-3xl font-bold text-white mt-1">Teacher Dashboard</h1>
            <p className="text-gray-400 mt-2">
              Track classrooms, assignments, and student progress.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-xl p-4">
            ...
            <p className="text-2xl font-semibold text-white mt-1">Manage sections</p>
            <p className="text-sm text-gray-500 mt-2">
              Organize classes, schedule tasks, and monitor completion.
            </p>
          </div>
          <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-xl p-4">
            <p className="text-sm text-gray-400">Assessments</p>
            <p className="text-2xl font-semibold text-white mt-1">Quizzes & grading</p>
            <p className="text-sm text-gray-500 mt-2">
              Review submissions and give timely feedback.
            </p>
          </div>
        </div>
